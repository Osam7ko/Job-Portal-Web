...
import com.osama.projects.jobportal.service.JobSeekerApplyService;
...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model, @RequestParam(value = "job", required = false) String job,
        ...
        model.addAttribute("freeLance", Objects.equals(partTime, "Free-Lance"));
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                ...
                for (JobPostActivity jobPostActivity : jobPost) {
                    ...
                    for (JobSeekerApply jobSeekerApply : jobSeekerApplyList) {
                        if (Objects.equals(
                                jobPostActivity.getJobPostId(), jobSeekerApply.getJobPostActivity().getJobPostId()
                        )) {
                    ...
                    for (JobSeekerSave jobSeekerSave : jobSeekerSaveList) {
                        if (Objects.equals(jobPostActivity.getJobPostId(), jobSeekerSave.getJobPostActivity().getJobPostId())) {
